<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Tin đấu giá</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="backend/newscate?type=dau-gia"><i class="fa fa-circle-o"></i> <span>Danh mục</span></a></li>
                <li><a href="backend/news?type=dau-gia"><i class="fa fa-circle-o"></i> <span>Danh sách</span></a></li>
              </ul>
            </li>            
            <!-- <li><a href="backend/orders"><i class="fa fa-shopping-cart"></i> <span>Quản lý đơn hàng</span></a></li> -->           
            <li><a href="backend/news?type=thu-tuc"><i class="fa fa-circle-o"></i> <span>Thủ tục</span></a></li>
